...
%\vspace{5mm}
%\includegraphics*{./images/htwk.png}	%  kleines logo
...
verwiesen.
%\subsubsection{Entwicklung von FreeBSD}
%
%- unixodies Betriebssystem
%- opensource
% performanter und robuster Netzwerkstack
%- IPv6 seit Ewigkeiten
%
%\subsubsection{FreeBSD heute}
%- FreeBSD <-> OpenBSD
%- Einsatz in allen ernstzunehmenden Unternehmen mit Internetschwerpunkt InternetExchange (-> Podcast)
%- Weiterf\"uhrende Literatur: FreeBSD-B\"ucher
